...
func NewMhsBiodata(nim, nama, ipk, hp, email, kodepstd, jenjang, prodi, namapst, kodepst, kodefak, namafak, jlrmasuk, thnmasuk, lamastd, tglsidang, kodejk string) *MhsBiodata {
	return &MhsBiodata{
		NIM:       nim,
		NAMA:      nama,
		IPK:       ipk,
