...
type Pagination struct {
	...
	CurrentRows uint32 `protobuf:"varint,4,opt,name=current_rows,json=currentRows,proto3" json:"current_rows,omitempty"`
}
...
func (x *Pagination) GetTotalRows() uint32 {
	if x != nil {
		return x.TotalRows
	}
	return 0
...
func (x *Pagination) GetCurrentRows() uint32 {
	if x != nil {
		return x.CurrentRows
	}
	return 0
}
...
var file_pagination_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x07, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x6c, 0x22, 0x92, 0x01, 0x0a, 0x0a,
	0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x6f,
	0x74, 0x61, 0x6c, 0x5f, 0x72, 0x6f, 0x77, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09,
	...
	0x52, 0x0b, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x67, 0x65, 0x12, 0x21, 0x0a,
	0x0c, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x72, 0x6f, 0x77, 0x73, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0b, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x52, 0x6f, 0x77, 0x73,
	...
	0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x42,
...
var file_pagination_proto_goTypes = []interface{}{
	...
	(*PaginationRequest)(nil), // 1: general.PaginationRequest
}
